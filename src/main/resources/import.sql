...
INSERT board (title, user_id) VALUES ('CodeSquad', 1);
...
INSERT board (title, user_id) VALUES ('daum', 2);

INSERT lists (title, position, board_id) VALUES ('list1', 1, 3);
INSERT lists (title, position, board_id) VALUES ('list2', 2, 3);
INSERT lists (title, position, board_id) VALUES ('list3', 3, 3);

INSERT card (title, position, board_id, lists_id) VALUES ('card1', 1, 3, 3);
INSERT card (title, position, board_id, lists_id) VALUES ('card2', 2, 3, 3);
INSERT card (title, position, board_id, lists_id) VALUES ('card3', 2, 3, 4);
INSERT card (title, position, board_id, lists_id) VALUES ('card4', 1, 3, 4);
INSERT card (title, position, board_id, lists_id) VALUES ('card5', 1, 3, 5);